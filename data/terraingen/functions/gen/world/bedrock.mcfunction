execute store result score @s perlinx run data get entity @s Pos[0] 200000
execute store result score @s perliny run data get entity @s Pos[2] 200000
#offsets
...
execute store result entity @e[tag=PlaceBlockBedrock,limit=1] Pos[1] double 0.00015 run scoreboard players get @s perlinOutput
